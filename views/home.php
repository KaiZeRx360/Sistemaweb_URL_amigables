...
<meta charset="UTF-8">
    ...
    <div class="container mt-2">
        <div class="d-flex justify-content-between align-items-center">
            <h5 class="neon-text">Bienvenido usuario</h5>
            <div>
    ...
    <div class="container mt-5">
        <h2 class="neon-text">Agregar productos</h2>
        <div class="row">
            <div class="col-md-4">
            ...
            <div class="col-md-8">
                <h3 class="neon-text">Lista de Productos</h3>
        ...
        <div class="modal-dialog">
            <div class="modal-content bg-secondary">
                <div class="modal-header">
                    <h5 class="modal-title neon-text" id="modalActualizarLabel">Actualizar Producto</h5>
